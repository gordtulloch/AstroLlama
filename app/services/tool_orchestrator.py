...
async def run_chat(
    ...
    if tools and llm_messages and llm_messages[0].get("role") == "system":
        ...
        simbad_hint = (
            ...
            "   - simbad_search: ONLY if the user explicitly says 'look up', 'search SIMBAD', "
            "'find data on [object]', or 'what are the coordinates/properties of [object]'. "
            "Never call it to answer general astronomy questions, explain concepts, or as a fallback.\n"
